...
export class PanelEditComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
      ...
      this.validationMessages = {
          'panelsManufacturer': {
              ...
              'minlength': 'Panel panelsManufacturer must be at least three characters.',
  ...
  getPanel(id: number): void {
      this.panelService.getPanel(id).subscribe(
  ...
  onPanelRetrieved(panel: IPanel): void {
      ...
      this.editForm = this.fb.group({
          'manufacturer': [this.panel.panelsManufacturer, [Validators.required,
                                       Validators.minLength(3),
                                       Validators.maxLength(50)]],
          'panelType': [this.panel.panelType, [Validators.required,
                                             Validators.maxLength(50)]],
